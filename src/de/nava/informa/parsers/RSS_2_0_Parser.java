...
class RSS_2_0_Parser implements ChannelParserIF {
    ...
    private static final Log LOG = LogFactory.getLog(RSS_2_0_Parser.class);
    ...
    public ChannelIF parse(ChannelBuilderIF cBuilder, Element root) throws ParseException {
        ...
        if (channel == null) {
            LOG.warn("Channel element could not be retrieved from feed.");
        ...
        if (image != null) {
            ...
            if (imgWidth != null) {
                try {
                    ...
                    LOG.warn("Error parsing width: " + e.getMessage());
                }
            }
        ...
        if (ttl != null) {
            ...
            try {
                ...
                LOG.warn("Invalid TTL format: '" + ttlValue + "'");
            }
        }
