...
class RSS_0_91_Parser implements ChannelParserIF {
    ...
    private static Log LOG = LogFactory.getLog(RSS_0_91_Parser.class);
    ...
    public ChannelIF parse(ChannelBuilderIF cBuilder, Element root) throws ParseException {
        ...
        for (Object item1 : items) {
            ...
            if (LOG.isDebugEnabled()) {
                LOG.debug("Item element found (" + strTitle + ").");
            }
        ...
        if (image != null) {
            ...
            ImageIF rssImage = cBuilder.createImage(image.getChildTextTrim("title"), ParserUtils.getURL(image.getChildTextTrim("url")),
        ...
        if (txtinp != null) {
            ...
            TextInputIF rssTextInput = cBuilder.createTextInput( txtinp.getChild("title").getTextTrim(), txtinp.getChild("description").getTextTrim(),
                            txtinp.getChild("name").getTextTrim(), ParserUtils.getURL(txtinp.getChild("link").getTextTrim()));
        ...
        if (cloud != null) {
            ...
            chnl.setCloud(cBuilder.createCloud( cloud.getAttributeValue("domain"), port, cloud.getAttributeValue("path"),
