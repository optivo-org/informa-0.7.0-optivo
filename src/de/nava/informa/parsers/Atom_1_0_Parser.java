...
public class Atom_1_0_Parser implements ChannelParserIF {
    private static final Log LOG = LogFactory.getLog(Atom_1_0_Parser.class);
    ...
    static String getAuthorString(List authors, Namespace defNS) {
        ...
        for (Object author1 : authors) {
            Element authorElt = (Element) author1;
    ...
    public ChannelIF parse(ChannelBuilderIF cBuilder, Element channel) throws ParseException {
        ...
        } else if ((defNS.getURI() == null) || !"http://www.w3.org/2005/Atom".equals(defNS.getURI())) {
            LOG.info("Namespace is not really supported, still trying assuming Atom 1.0 format");
        }
        ...
        while (i.hasNext()) {
            ...
            if (elTitle != null) {
                ...
                if (LOG.isDebugEnabled()) {
                    LOG.debug("Parsing title " + elTitle.getTextTrim() + "->" + strTitle);
                }
            }
