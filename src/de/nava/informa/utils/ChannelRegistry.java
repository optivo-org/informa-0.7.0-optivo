...
public class ChannelRegistry {
    ...
    private static final Log LOG = LogFactory.getLog(ChannelRegistry.class);
    ...
    public ChannelIF addChannel(ChannelIF channel, boolean active, int interval) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("added channel " + channel.getId() + " to registry");
        }
        if (active) {
    ...
    public void activateChannel(ChannelIF channel, int interval) {
        ...
        if (updateTasks.get(channel.getLocation()) == null) {
            ...
            if (LOG.isDebugEnabled()) {
                LOG.info("activating channel updates for " + channel.getTitle());
            }
    ...
    public void removeChannel(ChannelIF channel) {
        ...
        LOG.debug("removing channel from registry: " + channel.getTitle());
    }
    ...
    public void deactivateChannel(ChannelIF channel) {
        ...
        if (task != null) {
            if (LOG.isDebugEnabled()) {
                LOG.debug("update task canceled for " + channel.getTitle());
            }
            task.cancel();
