...
public final class FormatDetector {
    ...
    private static final Log LOG = LogFactory.getLog(FormatDetector.class);
    ...
    public static ChannelFormat getFormat(URL url) throws IOException, UnsupportedFormatException {
        LOG.debug("Trying to retrieve stream from " + url);
    ...
    public static ChannelFormat getFormat(InputStream in) throws IOException, UnsupportedFormatException {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("Detected [" + rootElement + "].");
        }
        if (rootElement.startsWith("rss")) {
            if (rootElement.indexOf("0.91") > 0) {
                ...
                LOG.info("RSS 0.93 not fully supported yet, fall back to 0.92.");
                ...
                LOG.info("RSS 0.94 not fully supported yet, fall back to 0.92.");
            ...
            LOG.debug("Channel uses RDF root element.");
