...
public final class FileUtils {
    ...
    public static boolean compare(File fileExpected, File fileActual) throws IOException {
        ...
        try {
            LOG.debug("Comparing golden file " + fileExpected + " to " + fileActual);
            readExpected = new BufferedReader(new FileReader(fileExpected));
        } catch (IOException e) {
            LOG.error("Could not read baseline: " + e);
            return false;
        }
    ...
    public static void copyFile(File inFile, File outFile) {
        try {
            ...
            LOG.info("Error occurred while copying file " + inFile + " to " + outFile, e);
        }
    }
