...
public class ChannelSearcher {
    ...
    private static final Log LOG = LogFactory.getLog(ChannelSearcher.class);
    ...
    public List<ItemResult> search(ChannelGroupIF channels, String queryString, int maxResults) throws QueryParseException, IOException {
        ...
        try {
            ...
            query = QueryParser.parse(queryString, ItemFieldConstants.TITLE_AND_DESC, analyzer);
        ...
        try {
            ...
            if (LOG.isDebugEnabled()) {
                LOG.debug("Query returned " + nrOfHits + " hits.");
            }
